...
//    ReadFilePFM(I, "/home/w/Desktop/DepthOut.pfm");
...
//    ofstream out("/home/w/Desktop/OutFromPFM.txt");

//    for(int i=0; i<Iresult.rows; i++)
//        for(int j=0; j<Iresult.cols; j++)
//            out << Iresult.at<uchar>(i,j)<<"  ";
//    out.close();
